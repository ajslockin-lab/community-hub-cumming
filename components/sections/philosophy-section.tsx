    ...
    <section id="resources" className="bg-background">
      ...
      <div ref={sectionRef} className="relative" style={{ height: "200vh" }}>
        <div className="sticky top-0 h-screen flex items-center justify-center">
          <div className="relative w-full">
            ...
            >
              <h2 className="text-[12vw] font-medium leading-[0.95] tracking-tighter text-foreground md:text-[10vw] lg:text-[8vw] text-center px-6 text-balance">
            ...
            <div className="relative z-10 grid grid-cols-1 gap-4 px-6 md:grid-cols-2 md:px-12 lg:px-20">
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <span className="backdrop-blur-md px-4 py-2 text-xs font-medium rounded-full bg-[rgba(255,255,255,0.2)] text-white uppercase tracking-wider">
                    Healthcare
                  </span>
                  <h3 className="mt-4 text-white text-2xl font-medium md:text-3xl">
                    Northside Hospital Forsyth
                  </h3>
                  <p className="mt-2 text-white/80 text-sm">
                    1200 Northside Forsyth Dr &middot; (770) 844-3200
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <p className="mt-2 text-white/80 text-sm">
                    585 Dahlonega Hwy &middot; (770) 781-9840
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-36 lg:pb-14">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-2xl md:text-3xl text-balance">
            From the hospital on Highway 20 to the library on Dahlonega Highway, 
            these institutions quietly hold Forsyth County together every single day.
          </p>
        </div>
      </div>
    </section>
