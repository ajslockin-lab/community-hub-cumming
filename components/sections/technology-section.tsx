...
export function TechnologySection() {
  ...
  const descriptionText = "Cumming Connects is a neighbor-built directory for Forsyth County. No ads. No gatekeeping. Just a clean, trusted place to find the help, programs, and people already here when you need them.";
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Built", "for", "Forsyth."].map((word, index) => {
                    // Each word fades out sequentially based on scrollProgress
                    const wordFadeStart = index * 0.07; // Your: 0, Community.: 0.07, Connected.: 0.14
